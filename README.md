...
首先，黑马点评 Plus 将 SpringBoot 版本升级到了 Spring Boot 4，并将其他的中间件，如：MybatisPlus、Redis、Redisson、RabbitMQ都升级到了最新版本。
...
> 详细文档与视频讲解：[javaup.chat](https://www.javaup.chat/hmdp-plus/overview/project-change)
